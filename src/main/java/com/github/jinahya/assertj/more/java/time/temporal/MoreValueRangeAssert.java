...
import com.github.jinahya.assertj.more.hidden.ForAbstractAssert;
 ...
 */
public interface MoreValueRangeAssert<SELF extends MoreValueRangeAssert<SELF>>
        extends MoreJavaTimeTemporalAssert<SELF, ValueRange> {
     ...
     */
    default SELF checksAsValidIntValue(final long value, final TemporalField field) {
...
//        }
        try {
            return MoreValueRangeAssertHelper.checkValidIntValue(value, field, (SELF) this, s -> r -> s);
        } catch (final DateTimeException dte) {
            final String errorMessage =
                    "<%1$d> supposed to be checked as a valid int value, but it wasn't.";
            if (true) {
                throw ForAbstractAssert.invokeFailure((AbstractAssert<?, ?>) this, errorMessage, value);
            }
            final String message = String.format(errorMessage, value);
